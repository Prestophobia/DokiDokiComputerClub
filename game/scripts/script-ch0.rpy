label ch0_main:
    ...
    s 1a "And it sounds like you already know Dolphin, is that right?"
    $ m_name = 'Dolphin'
    show sayori zorder 2 at t31
    ...
    "Dolphin smiles sweetly."
    "We do know each other - well, we rarely talked, but we were in the same class last year."
    "Dolphin was probably the most popular girl in class - smart, beautiful, athletic."
    "Basically, completely out of my league."
    "So, having her smile at me so genuinely feels a little..."
    mc "Y-You too, Dolphin."
    show monika zorder 1 at thide
    hide monika
    show sayori zorder 3 at f31
    s 4x "Come sit down, [player]! We made room for you at the table, so you can sit next to me or Dolphin."
    ...
    "As Sayori mentioned, it's been widened so that there is one space next to Dolphin and one space next to Sayori."
    ...
    "Sayori grabs one first, then Dolphin. I follow."
    show natsuki zorder 2 at t32
    show sayori zorder 3 at f31
    s 4q "It's delicious!"
    ...
    "Dolphin raises an eyebrow, then smiles at me."
    show yuri zorder 1 at thide
    hide yuri
    ...
    "Something tells me I shouldn't tell Dolphin that I was practically dragged here by Sayori."
    ...
    s "Dolphin really is a great leader!"
    ...
    "Dolphin must have worked really hard just to find these three."
    ...
    ny "...?"
    "Natsuki and Yuri look quizzically at Dolphin."
    ...
    show monika zorder 2 at t43
    "Dolphin smiles warmly at me once again."
    ...
    "Dolphin looks over at me once more."
    ...
    show monika zorder 1 at thide
    hide monika
    "Can I really impress the class star Dolphin with my mediocre writing skills?"
